...
27px(새 시트 20~23). v2.76.3 0.86(머리 23·키 40)은 키가 작아 v2.76.8에 0.94(머리 26·키 44~45)로 — 크기 통일이 먼저다.
"""
import hero_sheet as HS
STRIPS = {'qipunch': [(1,0),(1,1),(1,2),(1,3)], 'qipunchb': [(2,0),(2,1),(2,2),(2,3)]}
if __name__ == '__main__':
    HS.extract('sheets/hero_fx.png', STRIPS, 'review/hero_punch3.png', center='hair', share_width=True, stand_cell=(1,0), rows=3, cols=4, scale_mul=0.94)
