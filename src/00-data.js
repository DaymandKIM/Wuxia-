...
const SECT = {
  ...
  scene: {
    halls: { library:[0.22,0.365], gate:[0.50,0.335], clinic:[0.78,0.365], yard:[0.27,0.525], guest:[0.73,0.525] },   // v2.92.2 시트 전각(폭 ≤165)에 맞춰 뒷줄 2·가운데 산문·앞줄 2
    hero: [0.50, 0.615],
    yardX: [0.08, 0.92], yardY: [0.55, 0.645],  // 제자가 거니는 띠 — 앞줄 전각(0.525) 앞만. 전각 발치 안에 들어가면 지붕 위에 선 것처럼 보였다(v2.92.3)
