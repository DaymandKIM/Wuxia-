...
const HFX = {
  ...
  fadeT: 0.22,                   // 탄 소멸 연출
  aw: { aidle: 50, katk: 70, punch: 52, swordthrust: 54, swordslash: 52, swordspin: 56, fansweep: 56, fanspin: 56, fanstrike: 52, saberslash: 58, sabersmash: 58, saberspin: 52, spearthrust: 64, spearsweep: 54, spearspin: 60, staffswing: 58, staffsweep: 52, staffspin: 60, kickside: 56, kickround: 58, kickhigh: 52, flykick: 44, firekick: 44, cresckick: 46, burstkick: 46, run: 34, punchb: 52 },   // 특수 동작 프레임 폭 (v2.73 — 주인공 시트는 hero_sheet가 그림에 맞춰 재고 review/hero_specs.json에 적는다)
  // 캔버스 높이가 51을 넘는 동작 [높이, 위 여분] — 머리 위로 든 무기·큰 원 기운. 렌더는 위 여분만큼 위로 올려 땅을 맞춘다(v2.73)
  fh: { swordslash: [52, 1], sabersmash: [52, 1], saberspin: [52, 1], spearspin: [54, 3], staffspin: [54, 3] },
...
const EQUIP = {
  ...
  gradeW: [[70,25,5,0,0],[45,35,17,3,0],[25,38,27,9,1],[10,30,35,20,5],[3,20,37,30,10]],   // 구역별 등급 가중
