...
const HFX = {
  ...
  fadeT: 0.22,                   // 탄 소멸 연출
  aw: { aidle: 50, katk: 70, punch: 82, swordthrust: 84, swordslash: 52, swordspin: 54, fansweep: 46, fanspin: 48, fanstrike: 48, saberslash: 60, sabersmash: 60, saberspin: 60, spearthrust: 58, spearsweep: 58, spearspin: 58, staffswing: 48, staffsweep: 52, staffspin: 48, kickside: 56, kickround: 58, kickhigh: 52, flykick: 44, firekick: 44, cresckick: 46, burstkick: 46, run: 34, punchb: 82, idle: 32, hit: 32 },   // 특수 동작 프레임 폭 (v2.73 — 주인공 시트는 hero_sheet가 그림에 맞춰 재고 review/hero_specs.json에 적는다. idle·hit도 v2.73.2부터 새 시트)
  // 캔버스 높이가 51을 넘는 동작 [높이, 위 여분] — 머리 위로 든 무기·큰 원 기운. 렌더는 위 여분만큼 위로 올려 땅을 맞춘다(v2.73)
  fh: { punch: [52, 1], punchb: [55, 4], swordslash: [56, 5], swordspin: [53, 2], saberslash: [53, 2], sabersmash: [53, 2], saberspin: [54, 3], spearspin: [52, 1] },
