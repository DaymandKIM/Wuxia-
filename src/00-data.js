...
const SECT = {
  ...
  scene: {
    halls: { library:[0.22,0.41], gate:[0.50,0.375], clinic:[0.78,0.41], yard:[0.27,0.60], guest:[0.73,0.60] },   // v2.92.4 시트가 사라져 마당을 화면 전체로(뒷줄 2·가운데 산문·앞줄 2)
    hero: [0.50, 0.745],
    yardX: [0.08, 0.92], yardY: [0.655, 0.80],  // 제자가 거니는 띠 — 앞줄 전각(0.60) 앞만. 전각 발치 안에 들어가면 지붕 위에 선 것처럼 보였다(v2.92.3)
