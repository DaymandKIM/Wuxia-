...
const HFX = {
  ...
  fadeT: 0.22,                   // 탄 소멸 연출
  aw: { aidle: 50, katk: 70, punch: 54, punchdbl: 56, punchup: 54, qipunch: 72, qipunchb: 72, kickside2: 56, kickround2: 58, kickhigh2: 52, swordthrust: 90, swordslash: 74, swordspin: 56, fansweep: 58, fanspin: 56, fanstrike: 60, saberslash: 60, sabersmash: 60, saberspin: 60, spearthrust: 58, spearsweep: 58, spearspin: 58, staffswing: 58, staffsweep: 56, staffspin: 56, kickside: 70, kickround: 72, kickhigh: 70, flykick: 44, firekick: 44, cresckick: 46, burstkick: 46, run: 30, idle: 24, hit: 34 },   // 특수 동작 프레임 폭 (v2.73 — 주인공 시트는 hero_sheet가 그림에 맞춰 재고 review/hero_specs.json에 적는다. idle·hit도 v2.73.2부터 새 시트. 주먹 3종은 v2.76 hero_punch4, 발차기 3종은 v2.76.1 hero_kick3)
