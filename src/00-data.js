...
const SECT = {
  ...
  scene: {
    ...
    bgHalls: {                                   // 기와(2) 4채 = 사용자 sect_stage2_v1 차분(v2.92.7). 산문·터·초가는 그림이 오면
      yard:    { 2: { cx: 0.2386, by: 0.3467 } },
      clinic:  { 2: { cx: 0.7736, by: 0.3340 } },
      library: { 2: { cx: 0.2666, by: 0.7393 } },
      guest:   { 2: { cx: 0.7334, by: 0.7588 } },
    },
