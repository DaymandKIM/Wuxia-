...
const HFX = {
  ...
  fadeT: 0.22,                   // 탄 소멸 연출
  aw: { aidle: 50 },             // 특수 동작 프레임 폭 (기본 HERO.w)
  // 권기 주먹 빛무리 — 절정부터 맨손 양손 콤보 위에 얹는다 (v2.18).
  // katk 스트립은 한 팔 정권뿐이라 양손이 사라져 보였다 → 스트립 대신 발광.
  kfist: { r:[8,4.8,2.4], a:[0.32,0.52,0.95],
           c:['#5aa8e8','#a8d4f0','#f0f6ff'], pulse:0.15 },
