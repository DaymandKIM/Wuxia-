...
const S = {
  ...
  equip: { weapon:null, armor:null, trinket:null },   // 장착 { k:종류, g:품계 } (v2.67 도감형)
  eqLv:  { weapon:0, armor:0, trinket:0 },            // 자리 강화 — 장비를 갈아껴도 유지
  inv:   {},                     // 주머니 { 종류: [품계별 개수 ×5] } — mergeN개면 자동 합성
  codex: {},                     // 도감 { 종류: 얻어 본 품계 비트 } — 보유 효과의 근거
