...
SHOW = {
    ...
    'gaebang': [40, 22, 34, 28, 18, 38, 44, 30],
    'mudang': [24, 28, 44, 40, 30, 22, 38, 40],
    'hwasan': [32, 42, 34, 44, 20, 26, 32, 28],
    'ami': [32, 20, 26, 44, 18, 26, 28, 44],
    'dangmun': [30, 32, 44, 18, 28, 40, 20, 30],
    'magyo': [30, 44, 44, 22, 32, 40, 30, 26],
    'bamboo': [24, 42, 44, 38, 26, 28, 32, 22],
}
LABEL = {
    'sorim': ['향로', '목인장', '방석 더미', '종', '솔잎·빗자루', '돌 물확', '석등', '봉 거치대'],
    'gaebang': ['화톳불', '누더기 더미', '깨진 항아리', '대나무 묶음', '돗자리', '부서진 수레바퀴', '호리병 죽장', '짚더미'],
    'mudang': ['태극 석반', '향로 좌탁', '무기 거치대', '죽통 수반', '이끼 바위', '돗자리·방석', '석등', '분재'],
    'hwasan': ['이끼 낀 붉은 바위', '꽂힌 검', '매화 가지', '돌 푯말', '감은 밧줄', '깨진 돌계단', '무쇠 화로', '짚 과녁 더미'],
    'ami': ['석불 두상', '나무 바리때', '삼나무 가지 묶음', '작은 석탑', '짚 돗자리', '이끼 낀 통나무', '돌 수반', '풍경 기둥'],
    'dangmun': ['침 상자', '독 항아리', '표창 짚 인형', '감은 밧줄', '돌 작업대', '취통 거치대', '이끼 돌판', '나무 통'],
    'magyo': ['잉걸불 화로', '부서진 석상 귀물', '진홍 깃발', '뼈 무더기', '검은 돌 제단', '말뚝 해골', '금 간 항아리', '마른 가지 더미'],
    'bamboo': ['자른 대나무 묶음', '봉 거치대', '짚 인형', '대통 물받이', '바구니', '이끼 낀 바위', '대나무 울타리', '댓잎 더미'],
}
